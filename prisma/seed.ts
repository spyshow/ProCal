  ...
  const catalogData = [
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (400..1000A)", step: "0.01xIn", delay: "3..144s (at 3xIr)", defaultIr: 1000, defaultTr: 12 },
        S: { range: "0.6..10xIn (600..10000A)", step: "0.1xIn", delay: "0.05..0.4s", i2t: true, defaultIsd: 4000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (1500..15000A)", off: true, defaultIi: 10000 },
        G: { range: "0.2..1.0xIn (200..1000A)", delay: "0.1..0.8s" },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (500..1250A)", step: "0.01xIn", delay: "3..144s (at 3xIr)", defaultIr: 1250, defaultTr: 12 },
        S: { range: "0.6..10xIn (750..12500A)", step: "0.1xIn", delay: "0.05..0.4s", i2t: true, defaultIsd: 5000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (1875..18750A)", off: true, defaultIi: 12500 },
        G: { range: "0.2..1.0xIn (250..1250A)", delay: "0.1..0.8s" },
      }),
    },
    {
      category: "ACB",
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1000..2500A)", step: "0.01xIn", delay: "3..144s (at 3xIr)", defaultIr: 2500, defaultTr: 12 },
        S: { range: "0.6..10xIn (1500..25000A)", step: "0.1xIn", delay: "0.05..0.4s", i2t: true, defaultIsd: 10000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (3750..37500A)", off: true, defaultIi: 25000 },
        G: { range: "0.1..1.0xIn (250..2500A)", delay: "0.1..0.8s", defaultIg: 500, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1280..3200A)", step: "0.01xIn", delay: "3..144s (at 3xIr)", defaultIr: 3200, defaultTr: 12 },
        S: { range: "0.6..10xIn (1920..32000A)", step: "0.1xIn", delay: "0.05..0.4s", i2t: true, defaultIsd: 12800, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (4800..48000A)", off: true, defaultIi: 32000 },
        G: { range: "0.1..1.0xIn (320..3200A)", delay: "0.1..0.8s", defaultIg: 640, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1600..4000A)", step: "0.01xIn", delay: "3..144s (at 3xIr)", defaultIr: 4000, defaultTr: 12 },
        S: { range: "0.6..10xIn (2400..40000A)", step: "0.1xIn", delay: "0.05..0.4s", i2t: true, defaultIsd: 16000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (6000..50000A)", off: true, defaultIi: 40000 },
        G: { range: "0.1..1.0xIn (400..4000A)", delay: "0.1..0.8s", defaultIg: 800, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2000..5000A)", step: "0.01xIn", delay: "3..144s (at 3xIr)", defaultIr: 5000, defaultTr: 12 },
        S: { range: "0.6..10xIn (3000..50000A)", step: "0.1xIn", delay: "0.05..0.4s", i2t: true, defaultIsd: 20000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (7500..50000A)", off: true, defaultIi: 50000 },
        G: { range: "0.1..1.0xIn (500..5000A)", delay: "0.1..0.8s", defaultIg: 1000, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2520..6300A)", step: "0.01xIn", delay: "3..144s (at 3xIr)", defaultIr: 6300, defaultTr: 12 },
        S: { range: "0.6..10xIn (3780..63000A)", step: "0.1xIn", delay: "0.05..0.4s", i2t: true, defaultIsd: 25200, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (9450..63000A)", off: true, defaultIi: 63000 },
        G: { range: "0.1..1.0xIn (630..6300A)", delay: "0.1..0.8s", defaultIg: 1260, defaultTg: 0.1 },
      }),
    },
    ...
    // =========================================================================
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (320..800A)", delay: "0.5..24s (at 6xIr)", defaultIr: 800, defaultTr: 12 },
        S: { range: "1.5..10xIr (1200..8000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 3200, defaultTsd: 0.1 },
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (500..1250A)", delay: "0.5..24s (at 6xIr)", defaultIr: 1250, defaultTr: 12 },
        S: { range: "1.5..10xIr (1875..12500A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 6250, defaultTsd: 0.1 },
        I: { range: "2..15xIn (2500..18750A)", off: true, defaultIi: 12500 },
      }),
    },
    {
      category: "ACB",
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (320..800A)", delay: "0.5..24s (at 6xIr)", defaultIr: 800, defaultTr: 12 },
        S: { range: "1.5..10xIr (1200..8000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 4000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (1600..12000A)", off: true, defaultIi: 8000 },
        G: { range: "0.2..1.0xIn (160..800A)", delay: "0.1..0.4s", defaultIg: 160, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        S: { range: "1.5..10xIr (1500..10000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 5000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (2000..15000A)", off: true, defaultIi: 10000 },
        G: { range: "0.2..1.0xIn (200..1000A)", delay: "0.1..0.4s", defaultIg: 200, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        S: { range: "1.5..10xIr (1875..12500A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 6250, defaultTsd: 0.1 },
        I: { range: "2..15xIn (2500..18750A)", off: true, defaultIi: 12500 },
        G: { range: "0.2..1.0xIn (250..1250A)", delay: "0.1..0.4s", defaultIg: 250, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (800..2000A)", delay: "0.5..24s (at 6xIr)", defaultIr: 2000, defaultTr: 12 },
        S: { range: "1.5..10xIr (3000..20000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 8000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (4000..30000A)", off: true, defaultIi: 20000 },
        G: { range: "0.2..1.0xIn (400..2000A)", delay: "0.1..0.4s", defaultIg: 400, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1000..2500A)", delay: "0.5..24s (at 6xIr)", defaultIr: 2500, defaultTr: 12 },
        S: { range: "1.5..10xIr (3750..25000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 10000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (5000..37500A)", off: true, defaultIi: 25000 },
        G: { range: "0.2..1.0xIn (500..2500A)", delay: "0.1..0.4s", defaultIg: 500, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1280..3200A)", delay: "0.5..24s (at 6xIr)", defaultIr: 3200, defaultTr: 12 },
        S: { range: "1.5..10xIr (4800..32000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 12800, defaultTsd: 0.1 },
        I: { range: "2..15xIn (6400..48000A)", off: true, defaultIi: 32000 },
        G: { range: "0.2..1.0xIn (640..3200A)", delay: "0.1..0.4s", defaultIg: 640, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1600..4000A)", delay: "0.5..24s (at 6xIr)", defaultIr: 4000, defaultTr: 12 },
        S: { range: "1.5..10xIr (6000..40000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 16000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (8000..50000A)", off: true, defaultIi: 40000 },
        G: { range: "0.2..1.0xIn (800..4000A)", delay: "0.1..0.4s", defaultIg: 800, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      manufacturer: "Schneider",
      series: "Masterpact MTZ3",
      model: "MTZ3 H1 4000",
      ratedCurrent: 4000,
      poles: 3,
      breakingCapacity: 65,
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2000..5000A)", delay: "0.5..24s (at 6xIr)", defaultIr: 5000, defaultTr: 12 },
        S: { range: "1.5..10xIr (7500..50000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 20000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (10000..50000A)", off: true, defaultIi: 50000 },
        G: { range: "0.2..1.0xIn (1000..5000A)", delay: "0.1..0.4s", defaultIg: 1000, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2520..6300A)", delay: "0.5..24s (at 6xIr)", defaultIr: 6300, defaultTr: 12 },
        S: { range: "1.5..10xIr (9450..63000A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 25200, defaultTsd: 0.1 },
        I: { range: "2..15xIn (12600..63000A)", off: true, defaultIi: 63000 },
        G: { range: "0.2..1.0xIn (1260..6300A)", delay: "0.1..0.4s", defaultIg: 1260, defaultTg: 0.1 },
      }),
    },
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (500..1250A)", step: "0.01xIn", delay: "0.5..24s (at 6xIr)", defaultIr: 1250, defaultTr: 12 },
        S: { range: "1.5..10xIr (1875..12500A)", step: "0.5xIr", delay: "0.05..0.4s", i2t: true, defaultIsd: 5000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (2500..18750A)", off: true, defaultIi: 12500 },
      }),
    },
    {
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1000..2500A)", step: "0.01xIn", delay: "0.5..24s (at 6xIr)", defaultIr: 2500, defaultTr: 12 },
        S: { range: "1.5..10xIr (3750..25000A)", step: "0.5xIr", delay: "0.05..0.4s", i2t: true, defaultIsd: 10000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (5000..37500A)", off: true, defaultIi: 25000 },
        G: { range: "0.2..1.0xIn (500..2500A)", delay: "0.1..0.5s", defaultIg: 500, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1280..3200A)", step: "0.01xIn", delay: "0.5..24s (at 6xIr)", defaultIr: 3200, defaultTr: 12 },
        S: { range: "1.5..10xIr (4800..32000A)", step: "0.5xIr", delay: "0.05..0.4s", i2t: true, defaultIsd: 12800, defaultTsd: 0.1 },
        I: { range: "2..15xIn (6400..48000A)", off: true, defaultIi: 32000 },
        G: { range: "0.2..1.0xIn (640..3200A)", delay: "0.1..0.5s", defaultIg: 640, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1600..4000A)", step: "0.01xIn", delay: "0.5..24s (at 6xIr)", defaultIr: 4000, defaultTr: 12 },
        S: { range: "1.5..10xIr (6000..40000A)", step: "0.5xIr", delay: "0.05..0.4s", i2t: true, defaultIsd: 16000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (8000..50000A)", off: true, defaultIi: 40000 },
        G: { range: "0.2..1.0xIn (800..4000A)", delay: "0.1..0.5s", defaultIg: 800, defaultTg: 0.1 },
      }),
    },
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (400..1000A)", delay: "0.5..30s", defaultIr: 1000, defaultTr: 12 },
        S: { range: "1.5..10xIr (1500..10000A)", delay: "0.08..0.4s", i2t: true, defaultIsd: 4000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (1500..15000A)", off: true, defaultIi: 10000 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (500..1250A)", delay: "0.5..30s", defaultIr: 1250, defaultTr: 12 },
        S: { range: "1.5..10xIr (1875..12500A)", delay: "0.08..0.4s", i2t: true, defaultIsd: 5000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (1875..18750A)", off: true, defaultIi: 12500 },
      }),
    },
    {
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1000..2500A)", delay: "0.5..30s", defaultIr: 2500, defaultTr: 12 },
        S: { range: "1.5..10xIr (3750..25000A)", delay: "0.08..0.4s", i2t: true, defaultIsd: 10000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (3750..37500A)", off: true, defaultIi: 25000 },
        G: { range: "0.2..1.0xIn (500..2500A)", delay: "0.1..0.5s", defaultIg: 500, defaultTg: 0.1 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1280..3200A)", delay: "0.5..30s", defaultIr: 3200, defaultTr: 12 },
        S: { range: "1.5..10xIr (4800..32000A)", delay: "0.08..0.4s", i2t: true, defaultIsd: 12800, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (4800..48000A)", off: true, defaultIi: 32000 },
        G: { range: "0.2..1.0xIn (640..3200A)", delay: "0.1..0.5s", defaultIg: 640, defaultTg: 0.1 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1600..4000A)", delay: "0.5..30s", defaultIr: 4000, defaultTr: 12 },
        S: { range: "1.5..10xIr (6000..40000A)", delay: "0.08..0.4s", i2t: true, defaultIsd: 16000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (6000..50000A)", off: true, defaultIi: 40000 },
        G: { range: "0.2..1.0xIn (800..4000A)", delay: "0.1..0.5s", defaultIg: 800, defaultTg: 0.1 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2000..5000A)", delay: "0.5..30s", defaultIr: 5000, defaultTr: 12 },
        S: { range: "1.5..10xIr (7500..50000A)", delay: "0.08..0.4s", i2t: true, defaultIsd: 20000, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (7500..50000A)", off: true, defaultIi: 50000 },
        G: { range: "0.2..1.0xIn (1000..5000A)", delay: "0.1..0.5s", defaultIg: 1000, defaultTg: 0.1 },
      }),
    },
    {
      category: "ACB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2520..6300A)", delay: "0.5..30s", defaultIr: 6300, defaultTr: 12 },
        S: { range: "1.5..10xIr (9450..63000A)", delay: "0.08..0.4s", i2t: true, defaultIsd: 25200, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (9450..63000A)", off: true, defaultIi: 63000 },
        G: { range: "0.2..1.0xIn (1260..6300A)", delay: "0.1..0.5s", defaultIg: 1260, defaultTg: 0.1 },
      }),
    },
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (400..1000A)", delay: "5..30s", defaultIr: 1000, defaultTr: 12 },
        S: { range: "1.5..10xIr (1500..10000A)", delay: "0.1..0.5s", i2t: true, defaultIsd: 4000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (2000..15000A)", off: true, defaultIi: 10000 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (500..1250A)", delay: "5..30s", defaultIr: 1250, defaultTr: 12 },
        S: { range: "1.5..10xIr (1875..12500A)", delay: "0.1..0.5s", i2t: true, defaultIsd: 5000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (2500..18750A)", off: true, defaultIi: 12500 },
      }),
    },
    {
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1000..2500A)", delay: "5..30s", defaultIr: 2500, defaultTr: 12 },
        S: { range: "1.5..10xIr (3750..25000A)", delay: "0.1..0.5s", i2t: true, defaultIsd: 10000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (5000..37500A)", off: true, defaultIi: 25000 },
        G: { range: "0.2..1.0xIn (500..2500A)", delay: "0.1..0.5s", defaultIg: 500, defaultTg: 0.1 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1280..3200A)", delay: "5..30s", defaultIr: 3200, defaultTr: 12 },
        S: { range: "1.5..10xIr (4800..32000A)", delay: "0.1..0.5s", i2t: true, defaultIsd: 12800, defaultTsd: 0.1 },
        I: { range: "2..15xIn (6400..48000A)", off: true, defaultIi: 32000 },
        G: { range: "0.2..1.0xIn (640..3200A)", delay: "0.1..0.5s", defaultIg: 640, defaultTg: 0.1 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (1600..4000A)", delay: "5..30s", defaultIr: 4000, defaultTr: 12 },
        S: { range: "1.5..10xIr (6000..40000A)", delay: "0.1..0.5s", i2t: true, defaultIsd: 16000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (8000..50000A)", off: true, defaultIi: 40000 },
        G: { range: "0.2..1.0xIn (800..4000A)", delay: "0.1..0.5s", defaultIg: 800, defaultTg: 0.1 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2000..5000A)", delay: "5..30s", defaultIr: 5000, defaultTr: 12 },
        S: { range: "1.5..10xIr (7500..50000A)", delay: "0.1..0.5s", i2t: true, defaultIsd: 20000, defaultTsd: 0.1 },
        I: { range: "2..15xIn (10000..50000A)", off: true, defaultIi: 50000 },
        G: { range: "0.2..1.0xIn (1000..5000A)", delay: "0.1..0.5s", defaultIg: 1000, defaultTg: 0.1 },
      }),
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "B",
        curveType: "LSIG",
        L: { range: "0.4..1.0xIn (2520..6300A)", delay: "5..30s", defaultIr: 6300, defaultTr: 12 },
        S: { range: "1.5..10xIr (9450..63000A)", delay: "0.1..0.5s", i2t: true, defaultIsd: 25200, defaultTsd: 0.1 },
        I: { range: "2..15xIn (12600..63000A)", off: true, defaultIi: 63000 },
        G: { range: "0.2..1.0xIn (1260..6300A)", delay: "0.1..0.5s", defaultIg: 1260, defaultTg: 0.1 },
      }),
    },
    ...
    },
    {
      ...
      manufacturer: "ABB",
      series: "Tmax XT5",
      model: "XT5N 400 TMA 320A",
      ratedCurrent: 320,
      poles: 3,
      breakingCapacity: 36,
      tripUnit: "TMA (Thermal Magnetic)",
      datasheetUrl: "https://search.abb.com/library/Download.aspx?DocumentID=1SDC210100D0206&LanguageCode=en&DocumentPartId=&Action=Launch",
      settingsJson: JSON.stringify({ Ics: 36, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.7..1.0xIn (224..320A)", defaultIr: 320 }, magnetic: { range: "5..10xIn (1600..3200A)", defaultIm: 2500 } }),
    },
    {
      category: "MCCB",
      manufacturer: "ABB",
      ...
      tripUnit: "Ekip Dip LSI",
      datasheetUrl: "https://search.abb.com/library/Download.aspx?DocumentID=1SDC210100D0206&LanguageCode=en&DocumentPartId=&Action=Launch",
      settingsJson: JSON.stringify({ Ics: 36, standard: "IEC 60947-2", category: "A", curveType: "LSI", L: { range: "0.4..1.0xIn (128..320A)", delay: "3..12s", defaultIr: 320, defaultTr: 12 }, S: { range: "1.0..10xIn (320..3200A)", delay: "0.05..0.4s", i2t: true, defaultIsd: 1600, defaultTsd: 0.1 }, I: { range: "1.5..15xIn (480..4800A)", defaultIi: 3200 } }),
    },
    {
      category: "MCCB",
      manufacturer: "ABB",
    ...
    // =========================================================================
    {
      ...
      datasheetUrl: "https://download.schneider-electric.com/files?p_enDocType=Catalog&p_File_Name=LVPED217032EN.pdf&p_Doc_Ref=LVPED217032EN",
    ...
    },
    {
      ...
      poles: 3,
      breakingCapacity: 36,
      tripUnit: "TM-DC (Thermal Magnetic)",
      datasheetUrl: "https://www.se.com/il/en/product/LV438261/circuit-breaker-compact-nsx320f-dc-tmdc-320-a-4p/",
      settingsJson: JSON.stringify({
        Ics: 36,
        standard: "IEC 60947-2",
        category: "A",
        curveType: "TM",
        thermal: { range: "0.7..1.0xIn (224..320A)", defaultIr: 320 },
        magnetic: { range: "5..10xIn (1600..3200A)", defaultIm: 2500 },
      }),
    },
    {
      category: "MCCB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "A",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (128..320A)", delay: "16s at 6xIr", defaultIr: 320, defaultTr: 16 },
        S: { range: "1.5..10xIr (480..3200A)", delay: "<40ms", defaultIsd: 1920, defaultTsd: 0.04 },
        I: { range: "3520A fixed (11xIn)", defaultIi: 3520 },
      }),
    },
    {
      category: "MCCB",
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "A",
        curveType: "TM",
        thermal: { range: "0.8..1.0xIn (256..320A)", defaultIr: 320 },
        magnetic: { range: "6..10xIn (1920..3200A)", defaultIm: 3200 },
      }),
    },
    {
      category: "MCCB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "A",
        curveType: "LSI",
        L: { range: "0.5..1.0xIn (160..320A)", delay: "2..14s", defaultIr: 320, defaultTr: 10 },
        S: { range: "2..10xIr (640..3200A)", delay: "0.05..0.3s", i2t: true, defaultIsd: 1600, defaultTsd: 0.1 },
        I: { range: "2..12xIn (640..3840A)", defaultIi: 3200 },
      }),
    },
    {
      category: "MCCB",
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        curveType: "TM",
        thermal: { range: "0.7..1.0xIn (224..320A)", defaultIr: 320 },
        magnetic: { range: "5..10xIn fixed (1600..3200A)", defaultIm: 2500 },
      }),
    },
    {
      category: "MCCB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "A",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (128..320A)", delay: "0.5..17s", defaultIr: 320, defaultTr: 10 },
        S: { range: "1.5..10xIr (480..3200A)", delay: "0.08..0.3s", i2t: true, defaultIsd: 1600, defaultTsd: 0.1 },
        I: { range: "1.5..12xIn (480..3840A)", defaultIi: 3200 },
      }),
    },
    {
      category: "MCCB",
    ...
    },
    {
      ...
      settingsJson: JSON.stringify({
        ...
        category: "A",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (128..320A)", delay: "3..15s", defaultIr: 320, defaultTr: 10 },
        S: { range: "1.5..10xIr (480..3200A)", delay: "0.1..0.3s", i2t: true, defaultIsd: 1600, defaultTsd: 0.1 },
        I: { range: "1.5..15xIn (480..4800A)", defaultIi: 3200 },
      }),
    },
    {
      category: "MCCB",
    ...
    // =========================================================================
    // Iskra MCCBs - MOD Series (IEC 60947-2 Category A, MOD1..MOD6)
    // =========================================================================
    // --- MOD1 Series (Frame up to 100A) ---
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD1",
      ...
      breakingCapacity: 25,
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 25, Icu: 36, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (32..40A)", defaultIr: 40 }, magnetic: { range: "10xIn fixed (400A)", defaultIm: 400 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 25, Icu: 36, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (50..63A)", defaultIr: 63 }, magnetic: { range: "10xIn fixed (630A)", defaultIm: 630 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 25, Icu: 36, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (80..100A)", defaultIr: 100 }, magnetic: { range: "10xIn fixed (1000A)", defaultIm: 1000 } }),
    },

    // --- MOD2 Series (Frame up to 250A) ---
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD2",
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 25, Icu: 36, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (100..125A)", defaultIr: 125 }, magnetic: { range: "10xIn fixed (1250A)", defaultIm: 1250 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 36, Icu: 50, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (128..160A)", defaultIr: 160 }, magnetic: { range: "10xIn fixed (1600A)", defaultIm: 1600 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 36, Icu: 50, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (200..250A)", defaultIr: 250 }, magnetic: { range: "10xIn fixed (2500A)", defaultIm: 2500 } }),
    },

    // --- MOD3 Series (Frame up to 400A) ---
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD3",
      ...
      settingsJson: JSON.stringify({
        ...
        curveType: "TM",
        thermal: { range: "0.8..1.0xIn (256..320A)", defaultIr: 320 },
        magnetic: { range: "10xIn fixed (3200A)", defaultIm: 3200 },
      }),
    },
    {
      category: "MCCB",
      ...
      settingsJson: JSON.stringify({
        ...
        category: "A",
        curveType: "LSI",
        L: { range: "0.4..1.0xIn (128..320A)", delay: "2..14s", defaultIr: 320, defaultTr: 10 },
        S: { range: "1.5..10xIr (480..3200A)", delay: "0.08..0.3s", i2t: true, defaultIsd: 1600, defaultTsd: 0.1 },
        I: { range: "2..12xIn (640..3840A)", defaultIi: 3200 },
      }),
    },
    {
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 60, Icu: 85, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (320..400A)", defaultIr: 400 }, magnetic: { range: "10xIn fixed (4000A)", defaultIm: 4000 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      ...
      tripUnit: "Electronic LSI",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 60, Icu: 85, standard: "IEC 60947-2", category: "A", curveType: "LSI", L: { range: "0.4..1.0xIn (160..400A)", delay: "2..14s", defaultIr: 400, defaultTr: 10 }, S: { range: "1.5..10xIr (600..4000A)", delay: "0.08..0.3s", i2t: true, defaultIsd: 2000, defaultTsd: 0.1 }, I: { range: "2..12xIn (800..4800A)", defaultIi: 4000 } }),
    },

    // --- MOD4 Series (Frame up to 800A) ---
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD4",
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 60, Icu: 85, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (504..630A)", defaultIr: 630 }, magnetic: { range: "10xIn fixed (6300A)", defaultIm: 6300 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      ...
      tripUnit: "Electronic LSI",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 60, Icu: 85, standard: "IEC 60947-2", category: "A", curveType: "LSI", L: { range: "0.4..1.0xIn (252..630A)", delay: "2..14s", defaultIr: 630, defaultTr: 10 }, S: { range: "1.5..10xIr (945..6300A)", delay: "0.08..0.3s", i2t: true, defaultIsd: 3150, defaultTsd: 0.1 }, I: { range: "2..12xIn (1260..7560A)", defaultIi: 6300 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      ...
      tripUnit: "Electronic LSI",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 60, Icu: 85, standard: "IEC 60947-2", category: "A", curveType: "LSI", L: { range: "0.4..1.0xIn (320..800A)", delay: "2..14s", defaultIr: 800, defaultTr: 10 }, S: { range: "1.5..10xIr (1200..8000A)", delay: "0.08..0.3s", i2t: true, defaultIsd: 3200, defaultTsd: 0.1 }, I: { range: "2..12xIn (1600..9600A)", defaultIi: 8000 } }),
    },

    // --- MOD5 Series (Frame up to 1250A) ---
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD5",
      ...
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 60, Icu: 85, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (640..800A)", defaultIr: 800 }, magnetic: { range: "10xIn fixed (8000A)", defaultIm: 8000 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD5",
      model: "MOD5 3EM 1000A",
      ratedCurrent: 1000,
      poles: 3,
      breakingCapacity: 50,
      tripUnit: "Microprocessor LSI",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 50, Icu: 70, standard: "IEC 60947-2", category: "A", curveType: "LSI", L: { range: "0.4..1.0xIn (400..1000A)", delay: "2..14s", defaultIr: 1000, defaultTr: 10 }, S: { range: "1.5..10xIr (1500..10000A)", delay: "0.08..0.3s", i2t: true, defaultIsd: 4000, defaultTsd: 0.1 }, I: { range: "2..12xIn (2000..12000A)", defaultIi: 10000 } }),
    },
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD5",
      model: "MOD5 3EM 1250A",
      ratedCurrent: 1250,
      poles: 3,
      breakingCapacity: 50,
      tripUnit: "Microprocessor LSI",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 50, Icu: 70, standard: "IEC 60947-2", category: "A", curveType: "LSI", L: { range: "0.4..1.0xIn (500..1250A)", delay: "2..14s", defaultIr: 1250, defaultTr: 10 }, S: { range: "1.5..10xIr (1875..12500A)", delay: "0.08..0.3s", i2t: true, defaultIsd: 5000, defaultTsd: 0.1 }, I: { range: "2..12xIn (2500..15000A)", defaultIi: 12500 } }),
    },

    // --- MOD6 Series (Frame up to 1600A) ---
    {
      category: "MCCB",
      manufacturer: "Iskra",
      series: "MOD6",
      model: "MOD6 3NM 1600A",
      ratedCurrent: 1600,
      poles: 3,
      breakingCapacity: 50,
      tripUnit: "TMD",
      datasheetUrl: "https://www.iskra.eu/f/docs/Moulded-Case-Circuit-Breakers/Iskra_MCCB.pdf",
      settingsJson: JSON.stringify({ Ics: 50, Icu: 66, standard: "IEC 60947-2", category: "A", curveType: "TM", thermal: { range: "0.8..1.0xIn (1280..1600A)", defaultIr: 1600 }, magnetic: { range: "10xIn fixed (16000A)", defaultIm: 16000 } }),
    },
    ...
    // =========================================================================
    {
      ...
      breakingCapacity: 6,
      tripUnit: "C-Curve",
      datasheetUrl: "https://download.se.com/files?p_File_Name=CA909006E+%28web%29.pdf",
      settingsJson: JSON.stringify({ curveType: "C", thermalPickup: "1.13..1.45xIn", magneticPickup: "5..10xIn (50..100A)", Icn: 6, Icu: 10, Ics: 7.5, energyClass: 3, letThroughI2t: 18000, standard: "IEC/EN 60898-1 / IEC/EN 60947-2" }),
    },
    {
      category: "MCB",
    ...
    },
    {
      ...
      manufacturer: "Siemens",
      series: "SENTRON 5SV1",
      model: "5SV1316-6KK16 (1P+N compact)",
      ratedCurrent: 16,
      poles: 2,
      breakingCapacity: 6,
      tripUnit: "C-Curve / 30mA",
    ...
    },
    {
      ...
      breakingCapacity: 0,
      tripUnit: "230V Coil",
      datasheetUrl: "https://download.schneider-electric.com/files?p_Doc_Ref=MKTED210011EN&p_enDocType=Catalog&p_File_Name=TeSys_Catalog-MKTED210011EN_2026-07.pdf",
    ...
    },
    {
      ...
      breakingCapacity: 0,
      tripUnit: "Class 0.5S",
      datasheetUrl: "https://download.schneider-electric.com/files?p_Doc_Ref=PLSED310126EN_Web",
      settingsJson: JSON.stringify({ accuracyClass: "0.5S", protocol: "Modbus RTU", measurement: "V, I, P, Q, S, PF, THD, kWh", standard: "IEC 61557-12" }),
    },
    {
      category: "METER",
    ...
    },
    {
      ...
      manufacturer: "Iskra",
      series: "iMC",
      model: "iMC784 Power Quality Analyzer",
      ratedCurrent: 5,
      poles: 3,
      breakingCapacity: 0,
      tripUnit: "Class 0.2S",
