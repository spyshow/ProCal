  ...
  return (
    <div className="space-y-4 font-sans text-slate-900">
      ...
      <div className="grid grid-cols-4 gap-2.5 my-3">
        <div className="border border-amber-200 rounded-lg p-2 text-center bg-amber-50/60 shadow-xs">
          <span className="text-[10px] font-bold uppercase text-amber-800 block">Total Connected</span>
          <span className="text-sm font-black text-amber-950 font-mono">{totalConnectedKw.toFixed(1)} kW</span>
        </div>
        <div className="border border-sky-200 rounded-lg p-2 text-center bg-sky-50/60 shadow-xs">
          <span className="text-[10px] font-bold uppercase text-sky-800 block">Max Demand</span>
          <span className="text-sm font-black text-sky-950 font-mono">{totalDemandKw.toFixed(1)} kW</span>
        </div>
        <div className="border border-emerald-200 rounded-lg p-2 text-center bg-emerald-50/60 shadow-xs">
        ...
        <div className="border border-purple-200 rounded-lg p-2 text-center bg-purple-50/60 shadow-xs">
          <span className="text-[10px] font-bold uppercase text-purple-800 block">Max Phase Current</span>
          <span className="text-sm font-black text-purple-950 font-mono">{maxCurrentA.toFixed(1)} A</span>
        </div>
      </div>
      ...
      <table className="w-full text-center text-xs border border-slate-300 rounded-lg overflow-hidden shadow-xs">
        <thead>
          <tr className="bg-slate-900 text-white text-[10px] font-bold uppercase tracking-wider">
            ...
            <th className="p-2 border-r border-slate-800 text-center">Conn. (kW)</th>
            <th className="p-2 border-r border-slate-800 text-center">DF</th>
            <th className="p-2 border-r border-slate-800 text-center">Demand (kW)</th>
        ...
        <tfoot>
          <tr className="bg-slate-100 text-slate-900 font-bold text-xs border-t-2 border-slate-300">
            <td colSpan={5} className="p-2 border-r border-slate-200 uppercase tracking-wider text-center">
            ...
            <td className="p-2 border-r border-slate-200 text-center font-mono">3Φ</td>
            <td className="p-2 border-r border-slate-200 text-center font-mono">
