...
const RAW_BREAKER_SCHEDULE_TOUR_STEPS: Step[] = [
  ...
  },
  {
    ...
    contentDefault: 'Inspect nominal trip ratings (In), design currents (Ib), breaking capacities (Icu), and electronic trip units (MicroLogic / Ekip).',
    targetAttr: 'breaker-table',
    route: '/breaker-schedule',
    icon: FileText,
  },
  {
    id: 'breaker-selectivity',
    titleKey: 'tour.breakerSelectivity.title',
    titleDefault: 'Selectivity Grading & 1.6x Rule',
    subtitleKey: 'tour.breakerSelectivity.subtitle',
    subtitleDefault: 'Prevent Cascading Blackouts',
    contentKey: 'tour.breakerSelectivity.content',
    contentDefault: 'To achieve FULL discrimination (e.g. 125A breaker for 76.5A SMDB load), upstream MCCBs maintain a >=1.6x rating ratio over downstream 63A MCBs, preventing nuisance floor outages.',
    targetAttr: 'breaker-selectivity-col',
    route: '/breaker-schedule',
    icon: Shield,
  },
  {
    id: 'breaker-guide',
    titleKey: 'tour.breakerGuide.title',
    titleDefault: 'Engineering Guide & Sizing Rules',
    subtitleKey: 'tour.breakerGuide.subtitle',
    subtitleDefault: 'Detailed Electrical Standards & Explanations',
    contentKey: 'tour.breakerGuide.content',
    contentDefault: 'Click the "Sizing Guide" button anytime to open the complete reference on SMDB sizing, electronic trip unit setting (Ir), and selectivity grading.',
    targetAttr: 'breaker-guide-btn',
    route: '/breaker-schedule',
    icon: BookOpen,
  },
];
