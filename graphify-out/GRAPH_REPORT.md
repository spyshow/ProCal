...
## Corpus Check
- 410 files · ~570,670 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5435 nodes · 7786 edges · 322 communities (179 shown, 143 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d2000df`
...
2. `cn()` - 76 edges
3. `db` - 64 edges
4. `verifyProjectAccess()` - 60 edges
5. `TailwindConfigGenerator` - 58 edges
6. `getSessionUser()` - 54 edges
7. `useProject()` - 44 edges
8. `Project` - 41 edges
9. `sizeCableAndBreaker()` - 38 edges
10. `computeFeeders()` - 38 edges
...
Cohesion: 0.07
Nodes (32): POST(), mocks, post(), POST(), mocks, post(), POST(), mocks (+24 more)
...
Cohesion: 0.11
Nodes (33): main(), CableEntry, CableSchedulePage(), CableProtectionEvaluation, calculateCableAmpacity(), evaluateCableProtection(), formatCableSize(), getRiserCableLength() (+25 more)
...
Cohesion: 0.06
Nodes (37): DELETE(), GET(), PUT(), RouteParams, GET(), POST(), Where, escapeCsv() (+29 more)
...
### Community 34 - "HeroSlideshow.tsx"
Cohesion: 0.16
...
### Community 40 - "feeders.ts"
Cohesion: 0.05
Nodes (58): adapter, aptCurrent(), db, fmt(), main(), stubFinder(), BreakerEntry, BreakerBOMItem (+50 more)

### Community 41 - "settings/route.ts"
Cohesion: 0.24
...
Cohesion: 0.13
Nodes (19): GET(), POST(), create, findFirst, mocks, post(), POST(), create (+11 more)
...
### Community 72 - "sizeCableAndBreaker"
Cohesion: 0.11
Nodes (29): main(), createTower(), POST(), POST(), POST(), getBreakerCategory(), PanelDesignerPage(), wrapSvgLines() (+21 more)
...
Cohesion: 0.18
Nodes (11): devDependencies, @testing-library/jest-dom, tsx, @types/bcryptjs, @types/nodemailer, vitest, @testing-library/jest-dom, tsx (+3 more)
...
Cohesion: 0.13
Nodes (18): ReportsPage(), CoverPage(), CoverPageProps, ReportHeader(), ReportHeaderProps, SectionHeaderProps, RevisionsPanel(), RevisionsPanelProps (+10 more)
...
### Community 147 - "leads/[id]/route.ts"
Cohesion: 0.40
...
Cohesion: 0.07
Nodes (47): BOMSchedule(), BOMScheduleProps, CableBOMItem, BreakerRow, BreakerSchedule(), BreakerScheduleProps, MDBRow, MDBSchedule() (+39 more)
...
### Community 182 - "primary-foreground"
Cohesion: 0.67
Nodes (3): primary-foreground, $type, $value

### Community 185 - "integration.test.ts"
Cohesion: 0.13
Nodes (18): FloorData, CableRow, CableSchedule(), CableScheduleProps, VDRow, VDSchedule(), VDScheduleProps, calculateVoltageDrop() (+10 more)

### Community 187 - "secondary-foreground"
Cohesion: 0.67
...
### Community 228 - "useTranslation"
Cohesion: 0.05
Nodes (76): BillingPage(), BreakerFamilyOption, BreakerSchedulePage(), CalculatorContent(), DashboardPage(), BREAKER_FAMILY_THEME, Building, BuildingLoad (+68 more)
...
### Community 320 - "db.ts"
Cohesion: 0.08
Nodes (36): DELETE(), PATCH(), DELETE(), GET(), PUT(), POST(), DELETE(), PATCH() (+28 more)
...
## Knowledge Gaps
- **2980 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2975 more)
...
- **Why does `FloorItemDelegate` connect `FloorItemDelegate` to `FloorItem.ts`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `PrismaClient` connect `PrismaClient` to `prismaNamespace.ts`, `class.ts`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `coordination/page.tsx`, `useTranslation`, `reports/page.tsx`, `feeders.ts`, `sizeCableAndBreaker`, `cables.ts`, `integration.test.ts`, `sld/page.tsx`?**
